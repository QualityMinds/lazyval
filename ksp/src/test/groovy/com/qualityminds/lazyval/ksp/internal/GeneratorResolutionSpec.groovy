...
import com.qualityminds.lazyval.ksp.internal.codegen.cassandra.CassandraCodecGenerator
import com.qualityminds.lazyval.ksp.internal.codegen.mongo.MongoCodecGenerator
...
class GeneratorResolutionSpec extends Specification {
    ...
    void "empty candidate set yields empty result"() {
        when:
        def result = GeneratorResolution.INSTANCE.resolve(Set.of())
    ...
    void "candidates without supersedes are all active"() {
        ...
        when:
        def result = GeneratorResolution.INSTANCE.resolve(Set.of(a, b))
    ...
    void "chain: only active superseders drop their targets"() {
        ...
        when:
        def result = GeneratorResolution.INSTANCE.resolve(Set.of(a, b, c))
    ...
    void "diamond: shared descendant survives when all its superseders are themselves dropped"() {
        ...
        when:
        def result = GeneratorResolution.INSTANCE.resolve(Set.of(a, b, c, d))
    ...
    void "multiple active generators can supersede the same target"() {
        ...
        when:
        def result = GeneratorResolution.INSTANCE.resolve(Set.of(x, y, z))
    ...
    void "unknown supersession target is silently ignored"() {
        ...
        when:
        def result = GeneratorResolution.INSTANCE.resolve(Set.of(a))
    ...
    void "unrelated generators pass through untouched"() {
        ...
        when:
        def result = GeneratorResolution.INSTANCE.resolve(Set.of(a, b, unrelated))
    ...
    void "cycle in supersedes graph throws"() {
        ...
        when:
        GeneratorResolution.INSTANCE.resolve(Set.of(a, b))
    ...
    void "real generators: spring-data supersedes cassandra and mongodb codec"() {
        ...
        when:
        def result = GeneratorResolution.INSTANCE.resolve(Set.of(springData, cassandra, mongo))
