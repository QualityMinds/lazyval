...
class KspJsonbIT extends Specification {
    ...
    private static final String GENERATED_FILE_NAME = "LazyvalJsonbAdapters.kt"
    private static final String GENERATED_RESOLVER_FILE_NAME = "LazyvalJsonbContextResolver.kt"
