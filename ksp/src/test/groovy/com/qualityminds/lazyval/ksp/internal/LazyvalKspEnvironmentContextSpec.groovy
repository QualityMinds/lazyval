...
class LazyvalKspEnvironmentContextSpec extends Specification {
    ...
    void "Package for generator computed as '#expected' when #message"() {
        ...
        fallback = "fallback"
        config = PackageLookup.DefaultConfig.of(basePackage, defaultLayer) as PackageLookup.DefaultConfig
