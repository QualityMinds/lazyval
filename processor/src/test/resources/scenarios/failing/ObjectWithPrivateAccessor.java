 ...
 * <p>
 * The error lands on the accessor that is already here rather than on the field, because asking the
 * author for a second accessor when this one only needs widening would be the wrong advice.
 */
@LazyValue
