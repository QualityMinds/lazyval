...
@RestController
@RequestMapping(value = "/order/mongo", produces = MediaType.APPLICATION_JSON_VALUE)
public class MongoOrderController implements OrderCassandraApi {

    private final RestMapper mapper;
    private final OrderRepository repository;

    public MongoOrderController(RestMapper mapper,
                                @Qualifier("mongo") OrderRepository repository) {
        this.mapper = mapper;
