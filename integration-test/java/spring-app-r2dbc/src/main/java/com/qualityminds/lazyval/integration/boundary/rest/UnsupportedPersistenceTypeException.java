 ...
 * not wired in this deployment — everything except R2DBC, here. Extends
 * {@link UnsupportedOperationException} for readability, but the 501 handler binds to this subtype
 * only: mapping the JDK type would silently turn genuine bugs into "not implemented" responses.
 */
