 ...
 * <p>
 * Takes the {@link ServerWebExchange} rather than a servlet request — this scenario runs on WebFlux.
 */
...
public class UnsupportedPersistenceTypeHandler {
    ...
    public ResponseEntity<Problem> handleUnsupportedPersistenceType(
            UnsupportedPersistenceTypeException ex, ServerWebExchange exchange) {
