 ...
 * in this deployment — everything except R2DBC, here. Extends [UnsupportedOperationException] for
 * readability, but the 501 handler binds to this subtype only: mapping the stdlib type would
 * silently turn genuine bugs into "not implemented" responses.
 */
