 ...
 * implement one answers 501 instead. Move a type out of this spec as soon as the Spring app
 * actually wires it up — these two are the backends still being built.
 */
@Title("Kotlin - Spring unsupported persistence type")
