...
@Mapper(componentModel = MappingConstants.ComponentModel.DEFAULT, uses = { LazyvalMapper.class })
public interface TestMapper {
    ...
    Order toDomainOrder(com.qualityminds.lazyval.integration.client.model.Order client);

    List<Order> toDomainOrder(List<com.qualityminds.lazyval.integration.client.model.Order> client);
}
