...
public class ScenarioFactory<T extends Scenario> {
    ...
    private ImmutableCollection<? extends ClasspathDependency<?>> dependencies = Lists.immutable.empty();
    ...
    public ScenarioFactory<T> withDependencies(ClasspathDependency<?>... dependencies) {
        this.dependencies = Lists.immutable.of(dependencies);
        return this;
    }

    public ScenarioFactory<T> withDependencies(Iterable<ClasspathDependency<?>> dependencies) {
