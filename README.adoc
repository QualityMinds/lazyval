...
* Codegenerators
** Bean-Validation ValueExtractors (useful for legacy/migration projects where after-the-fact validation is still needed)
** Cassandra
...
** MapStruct mapper
** MongoDB
** Spring-Data (Cassandra, Mongo, Jdbc, R2dbc)
* Smart
