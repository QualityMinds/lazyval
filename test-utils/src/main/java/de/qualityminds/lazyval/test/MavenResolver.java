package de.qualityminds.lazyval.test;
...
public class MavenResolver {
    ...
    public static List<File> resolveDependencies(String... coordinates) {
     ...
     */
    public static List<File> getCoreModuleClasses() {
        ...
        if (coreClassesDir.exists() && coreClassesDir.isDirectory()) {
            ...
            logger.debug("Added core classes: " + coreClassesDir.getAbsolutePath());
        }
